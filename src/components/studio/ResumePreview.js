...
function PreviewPersonal({ data, accent }) {
 ...
 return (
 <div className="text-center mb-5 border-b pb-3" style={{ borderColor: accent }}>
...
function SectionTitle({ children }) {
 return <h2 className="text-[12pt] font-bold border-b border-gray-400 mb-2 mt-4">{children}</h2>;
}
